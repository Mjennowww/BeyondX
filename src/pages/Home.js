    ...
    if (countdown !== null && countdown >= 0) {
      ...
      return (
        <span>
          ...
          <span style={{ textTransform: "uppercase" }}>hours</span>,{" "}
          <span
            style={{
              fontWeight: "700",
              fontSize: "26px",
          ...
          <span style={{ textTransform: "uppercase" }}>minutes</span>,{" "}
          <span
            style={{
              fontWeight: "700",
              fontSize: "26px",
          ...
          <span style={{ textTransform: "uppercase" }}>seconds</span>
        </span>
      );
    }
    return "";
        ...
        <div className="inner-content-container">
          ...
          <div className="home-article-container">
            ...
            >
              ...
              <p className="cardtitle" style={{ color: "#fefefe" }}>
                Details ->
              </p>
            </Link>
